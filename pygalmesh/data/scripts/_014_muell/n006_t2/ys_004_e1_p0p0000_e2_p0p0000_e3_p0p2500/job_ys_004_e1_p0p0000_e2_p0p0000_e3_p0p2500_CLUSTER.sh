...
#SBATCH -e /w/pygalmesh/data/scripts/014-Yield-Surface-From-leS/yield_surface_jobs/n006/ys_004_e1_p0p0000_e2_p0p0000_e3_p0p2500/%x.err.%j
#SBATCH -o /w/pygalmesh/data/scripts/014-Yield-Surface-From-leS/yield_surface_jobs/n006/ys_004_e1_p0p0000_e2_p0p0000_e3_p0p2500/%x.out.%j
#SBATCH -C i01
