...
| Zweck | Pfad |
|---|---|
| **Preprocessing + Vernetzung (Hauptpipeline)** | `Meshing/pygalmesh/data/scripts/015-Yield-Surface-Batch-leS/` |
...
| **Simulationstemplate (elasto-plastisch)** | `.../015-Yield-Surface-Batch-leS/00_template/elastoplastic.py` |
...
| Ergebnisse | `.../015-Yield-Surface-Batch-leS/00_results/` |
