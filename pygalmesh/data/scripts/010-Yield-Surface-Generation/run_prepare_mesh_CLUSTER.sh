...
# Runner der Netzvorbereitung. Quellenunabhaengig: waehlt anhand von
# A01_les_2_npy.enabled in der Config zwischen der .leS-Kette (A01 + 02b) und
# der DICOM-Kette (00/01/02/02a + 02b). Wird von job_prepare_mesh_CLUSTER.sh
# aufgerufen; frueherer Name: job_prepare_mesh_Bin4_reduce_2_CLUSTER.sh
set -euo pipefail
