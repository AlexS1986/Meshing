#!/usr/bin/env python3
"""
A01_les_2_npy.py — Einstiegspunkt der .leS-Pipeline in 015-Yield-Surface-Batch-leS.
...
-------
    ...
    python3 A01_les_2_npy.py --config /data/scripts/015-Yield-Surface-Batch-leS/config-A01-les.json
