...
BASE_PATH="/data/scripts/017-Yield-Surface-Batch-leS-nohinge"
...
YIELD_JOB_CONSTRAINT="${YIELD_JOB_CONSTRAINT:-}"   # 03.09.2026: leer = i01 oder i02 (i01 vom HRZ abgeschaltet)
...
JOB_ACCOUNT="${JOB_ACCOUNT:-special00008}"   # 09.09.2026: Nutzerentscheidung - nicht auf l0003507 rechnen (Budget), Default p0023647
