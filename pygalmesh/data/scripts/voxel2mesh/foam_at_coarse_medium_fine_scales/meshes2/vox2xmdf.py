...
file_path = os.path.join("/data","resources","erik","test_foam_80x80x80.leS")
...
vol = np.array(data,dtype=np.uint8).reshape((subarray_size, subarray_size, subarray_size))
...
script_path = os.path.dirname(__file__)
input_mesh_path = os.path.join(script_path,"foam"+str(subarray_size)+"_corrected_to_box.xdmf")
