...
`/data/scripts/015-Yield-Surface-Batch-leS/A01_segmented/` — dieser Pfad wird
...
sbatch "$HPC_SCRATCH/pygalmesh/data/scripts/015-Yield-Surface-Batch-leS/job_prepare_mesh_CLUSTER.sh"
