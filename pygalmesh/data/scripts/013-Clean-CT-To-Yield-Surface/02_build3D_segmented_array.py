...
def main():
    ...
    # 010 read "desired_width_y" while every config wrote "desired_height_y",
    # so a configured y-width was silently ignored. Accept both.
    desired_width_y = cfg.get("desired_height_y", cfg.get("desired_width_y"))
