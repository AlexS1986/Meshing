...
(`$HOME/meshing/Meshing/pygalmesh/data/scripts/017-Yield-Surface-Batch-leS-nohinge/`) —
...
```bash
cd "$HOME/meshing/Meshing/pygalmesh/data/scripts/017-Yield-Surface-Batch-leS-nohinge"
...
data/scripts/017-Yield-Surface-Batch-leS-nohinge/batch_create_folders_CLUSTER.sh

# 2) alles einreichen: 4 Netzvorbereitungen + 768 Punkt-Jobs mit afterok
"$HPC_SCRATCH/pygalmesh/data/scripts/017-Yield-Surface-Batch-leS-nohinge/batch_submit_CLUSTER.sh"

# 3) Stand ansehen (jederzeit)
"$HPC_SCRATCH/pygalmesh/data/scripts/017-Yield-Surface-Batch-leS-nohinge/batch_status_CLUSTER.sh"

# 4) Ergebnisse einsammeln und zippen
"$HPC_SCRATCH/pygalmesh/data/scripts/017-Yield-Surface-Batch-leS-nohinge/batch_collect_results.sh"
```
...
```bash
scp '<user>@<login-node>:$HPC_SCRATCH/pygalmesh/data/scripts/017-Yield-Surface-Batch-leS-nohinge/00_results/_packages/*.zip' .
```
