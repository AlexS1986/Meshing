#!/usr/bin/env python3
"""
A01_les_2_npy.py — Einstiegspunkt der .leS-Pipeline in 017-Yield-Surface-Batch-leS-nohinge.
...
-------
    ...
    python3 A01_les_2_npy.py --config /data/scripts/017-Yield-Surface-Batch-leS-nohinge/config-A01-les.json
...
PROJECT_CONTAINER_DIR = "/data/scripts/017-Yield-Surface-Batch-leS-nohinge"
