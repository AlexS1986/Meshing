...
bash "$SCRIPT_DIR/job_yield_surface_point_CLUSTER.sh" "/data/scripts/010-Yield-Surface-Generation/yield_surface_jobs/n006/ys_001_e1_m0p2500_e2_p0p0000_e3_p0p0000/config.json"
