...
# Bin4 reduce-2 coarse mesh (max_element_size_factor=1.0,
# max_facet_distance_factor=0.3). Requires
# job_generate_mesh_Bin4_reduce_2_CLUSTER.sh (array index 0 /
# config-Bin4-reduce-2-mesh-coarse.json) to have completed first, or
...
SRUN_MEM_PER_CPU=4000 \
  bash "$SCRIPT_DIR/job_run_simulation_CLUSTER.sh" config-Bin4-reduce-2-mesh-coarse.json
