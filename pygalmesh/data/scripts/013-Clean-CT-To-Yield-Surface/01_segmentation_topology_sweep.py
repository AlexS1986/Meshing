...
# Sweep over the segmentation parameters of the rewritten 01 step.
# The old variants used `gaussian_sigma_pixels` and the per-slice morphology
# knobs, which no longer exist: sigma is now `gaussian_sigma_voxels` and is
# applied in 3D, and 3D morphology lives in 02c where it can see real
# components. `no_smoothing` reproduces what 010 effectively did, because its
# sigma of 0.134 voxels was numerically the identity.
DEFAULT_VARIANTS = [
    {
        "name": "no_smoothing_010_equivalent",
    ...
    {
        "name": "gauss3d_0p5",
        "01_segment_slice_wise": {"smoothing_mode": "3d", "gaussian_sigma_voxels": 0.5},
    },
    {
        "name": "gauss3d_1p0",
        "01_segment_slice_wise": {"smoothing_mode": "3d", "gaussian_sigma_voxels": 1.0},
    },
    {
        "name": "gauss3d_1p5",
        "01_segment_slice_wise": {"smoothing_mode": "3d", "gaussian_sigma_voxels": 1.5},
    },
    {
        "name": "gauss2d_1p0",
        "01_segment_slice_wise": {"smoothing_mode": "2d", "gaussian_sigma_voxels": 1.0},
    },
    {
        "name": "gauss3d_1p0_global_otsu",
        "01_segment_slice_wise": {
            "smoothing_mode": "3d",
    ...
    {
        "name": "gauss3d_1p0_threshold_low_0p98",
        "01_segment_slice_wise": {
            "smoothing_mode": "3d",
            "gaussian_sigma_voxels": 1.0,
    ...
    {
        "name": "gauss3d_1p0_threshold_high_1p02",
        "01_segment_slice_wise": {
            "smoothing_mode": "3d",
            "gaussian_sigma_voxels": 1.0,
