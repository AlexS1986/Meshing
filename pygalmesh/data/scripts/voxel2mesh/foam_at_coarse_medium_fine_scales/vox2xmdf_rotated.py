...
output_mesh_path_coarse = os.path.join(script_path,"coarse_pores_y_rotated.xdmf")
output_mesh_path_medium = os.path.join(script_path,"medium_pores_y_rotated.xdmf")
output_mesh_path_fine = os.path.join(script_path,"fine_pores_y_rotated.xdmf")
...
mirror_dir_index = 1 # y direction

# 1. mirror in y-direction
mesh = mmm.mirror_and_merge_old(mesh,mirror_direction=mirror_dir_index,
...
import math
mesh = mmm.rotate_mesh(mesh,'z',math.pi/2.0)
