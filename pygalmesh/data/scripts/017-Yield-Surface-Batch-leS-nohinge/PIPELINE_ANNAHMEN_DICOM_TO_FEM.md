...
| Zweck | Pfad |
|---|---|
| **Preprocessing + Vernetzung (Hauptpipeline)** | `Meshing/pygalmesh/data/scripts/017-Yield-Surface-Batch-leS-nohinge/` |
...
| **Simulationstemplate (elasto-plastisch)** | `.../017-Yield-Surface-Batch-leS-nohinge/00_template/elastoplastic.py` |
...
| Ergebnisse | `.../017-Yield-Surface-Batch-leS-nohinge/00_results/` |
