...
def process_plt_file(filename):
    ...
    print(f"[{filename}] Original points: {len(points)}, Unique points: {len(unique_points)}, Filtered points: {len(filtered_points)}")
    ...
    print(f"[{filename}] Point cloud visualization saved as {output_image_filename}")
    ...
    print(f"[{filename}] Meshes saved as {bpa_mesh_obj_filename} and {dec_mesh_obj_filename}")
    ...
    print(f"[{filename}] Meshes converted and saved as {bpa_mesh_vtk_filename} and {dec_mesh_vtk_filename}")

# Process both files
process_plt_file("emodul")
process_plt_file("gmodul")
