...
#
# All three tiers (coarse=1.0/0.3, medium=0.75/0.2, fine=0.5/0.1 --
# max_element_size_factor/max_facet_distance_factor) are generated by
# create_mesh_resolution_configs.py; none of them reuse
# config-Bin4-reduce-2-cluster-fine.json's own mesh parameters (3.0/1.0),
# which is a separate, unrelated baseline.
