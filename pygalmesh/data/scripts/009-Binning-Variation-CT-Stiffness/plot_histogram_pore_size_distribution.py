...
if __name__ == "__main__":
    specimen = "JM-25-74"
    binning = "Bin1"
    filename = f"Probe Nr. {specimen}_{binning}.txt"
    file_path = os.path.join(
        "/data",
        "resources",
        "B02_Mevert_AlSi10MgSchaum_JM-26-74_Binning_Variation",
        "Binning 1",
        filename,
    )
    script_path = os.path.dirname(__file__)
    output_file = os.path.join(script_path, f"{specimen}_{binning}_pore_histogram.png")
