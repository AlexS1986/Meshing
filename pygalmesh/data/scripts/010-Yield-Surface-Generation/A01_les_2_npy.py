#!/usr/bin/env python3
"""
A01_les_2_npy.py — Einstiegspunkt der .leS-Pipeline in 010-Yield-Surface-Generation.
...
-------
    ...
    python3 A01_les_2_npy.py --config /data/scripts/010-Yield-Surface-Generation/config-A01-les.json
