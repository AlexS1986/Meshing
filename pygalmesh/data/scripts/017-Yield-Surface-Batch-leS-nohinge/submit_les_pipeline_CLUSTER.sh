...
SCRIPT_DIR="$HPC_SCRATCH/pygalmesh/data/scripts/017-Yield-Surface-Batch-leS-nohinge"
...
if [[ "${#POINT_JOBS[@]}" -eq 0 ]]; then
  ...
  echo "  YIELD_SURFACE_POINTS=$POINTS data/scripts/017-Yield-Surface-Batch-leS-nohinge/02_create_folders_CLUSTER.sh" >&2
  exit 2
fi
