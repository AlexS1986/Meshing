# CLAUDE.md — 014-Yield-Surface-From-leS

Fließflächen-Erzeugung aus einem **bereits segmentierten Voxelbild** (`.leS`).
Abspaltung von `010-Yield-Surface-Generation` ohne den DICOM-Zweig: alles, was
Rekonstruktion und Segmentierung aus DICOM betraf, ist hier entfernt.
...
| Zweck | Pfad |
|---|---|
| dieses Projekt (Host, Mac) | `~/Work/Hypo/Hypo/Simulation/Meshing/pygalmesh/data/scripts/014-Yield-Surface-From-leS/` |
| dieses Projekt (Cluster) | `$HPC_SCRATCH/pygalmesh/data/scripts/014-Yield-Surface-From-leS/` |
| dieses Projekt (Container) | `/data/scripts/014-Yield-Surface-From-leS/` |
